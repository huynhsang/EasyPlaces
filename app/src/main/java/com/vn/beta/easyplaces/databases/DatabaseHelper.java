...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DBNAME = "OwnerDB.sqlite";
    private static final String DB_PATH_NAME = "db/OwnerDB.sqlite";
    private static final String DBLOCATION = "/data/data/com.vn.beta.easyplaces/databases/";
